(function(global) {
 global.$_Tawk_AccountKey = '5eb4f6c2a1bad90e54a2d139';
...
//   };
   wa.prototype.log = function(a, b) {
    var d;
    b && a && (b.uiVersion = "v3", b.buildVersion = "683", b.buildCommit = "d673d52375a87d6a5dbfec9cab2327b8f1813a82", d = {
     type: a,
     data: b
...
//   };
   ...
   X.prototype.extractRegisterData = function(a) {
    a.wdgt && (a.wdgt.lc !== u.widgetSettings.lc && (this.waitingForLanguage = !0, n.insertScript("https://static-v.tawk.to/683/languages/" + a.wdgt.lc + ".js")), m.processSettings(a.wdgt));
